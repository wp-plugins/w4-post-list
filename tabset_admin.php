...
?>
	<div id="tabset_wrapper" class="wrap">
        ...
        <h2>W4 content tabset <?php echo "V-".TABSET_VERSION ; ?> options</h2>
        <p class="info">
		Developed by <a href="http://w4dev.com" class="us" rel="developer" title="Web and wordpress development...">W4 development</a>
        <a id="tabset_help" href="javascript:void(0);" title="Tabset documentation"> Need help ?</a>
        <a href="http://w4dev.com/w4-plugin/post-page-custom-tabset-shortcode" title="Visit Plugin Site"> Visit Plugin Site</a>
        <a href="http://www.facebook.com/w4dev" title="Find us on facebook">Find us on facebook</a>
        <a href="mailto:sajib1223@gmail.com" rel="tabset_author_mail"> Mailto: Direct Contact</a><br />
		<span class="notice">Note: The Anchor tabser has been removed from this version also the style. Now it is taking a new option, "effect".</span>
        </p>
	...
	<table class="form-table">
        <tbody>
			<tr valign="top">
                ...
                <td><input type="submit" id="save-tabset-options" name="save-tabset-options" class="button-primary" value="Save Tabset option" /></td>
			</tr>
            ...
            <tr valign="top">
                ...
                <td><input type="submit" id="save-tabset-options" name="save-tabset-options" class="button-primary" value="Save Tabset option" /><br />
