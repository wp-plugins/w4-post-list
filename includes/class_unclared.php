...
#		if( preg_match( '/category_effect/', $this->cat_template ))
#		if( !in_array( $this->list_effect, array( 'extended', 'yes'))){
#			if( $this->list_has_effect )
#				$this->cat_template = preg_replace( "/category_effect/", '', $this->cat_template );
#
#			$this->list_has_effect = false;
#		}
...
#			if( 'yes' == $this->list_effect )
#				$this->cat_template = preg_replace( "/category_effect/", 'category_effect open', $this->cat_template );

#			if( 'extended' == $this->list_effect )
#				$this->cat_template = preg_replace( "/category_effect/", 'category_effect close', $this->cat_template );
#		}
