...
class W4PL_Admin_Page_Docs 
{
	...
	?>
		...
		<div class="inside">
			<?php _e('We have found a database table that were used by an older version of this plugin. We recommend you import the old list information, and delete the table.', W4PL_TD); ?>
		...
		<div class="inside">
			...
			<p><?php 
			_e( 'Use shortcode "postlist" with the list id to show a list on post/page content area.', W4PL_TD );
			_e( 'ex:', W4PL_TD); ?> <code>[postlist 1]</code></p>

			<strong>Function</strong>
			<p><?php 
			_e( 'Display list directly to your theme using do_shortcode function.', W4PL_TD ); ?>
		...
		<ul class="w4outlinks">
			...
			<li><a class="button" href="<?php echo add_query_arg( array( 'utm_source' => $siteurl, 'utm_medium' => 'w4%2Bplugin', 'utm_campaign' => W4PL_TD ), 'http://w4dev.com/w4-plugin/w4-post-list' ); ?>" target="_blank">Visit Plugin Page</a></li>
			<li><a class="button" href="<?php echo add_query_arg( array( 'utm_source' => $siteurl, 'utm_medium' => 'w4%2Bplugin', 'utm_campaign' => W4PL_TD ), 'http://w4dev.com/wp/w4-post-list-examples/#examples' ); ?>" target="_blank">Designing Examples</a></li>
		...
		<h2><?php _e( '<strong>Example</strong>: Simple Unordered Post List', W4PL_TD ); ?></h2>
		<pre><code>[posts]
  &lt;ul&gt;
...
[/posts]</code></pre>
		...
		<h2><?php _e( 'Example: Post list having excerpt limited to 20 words, and using post class on post wrapper element', W4PL_TD ); ?></h2>
		<pre><code>[posts]
...
[/posts]</code></pre>
		...
		<h2><?php _e( 'Example: Post list Group by Year (chose <em>Group By</em> option to Year while using this).', W4PL_TD ); ?></h2>
		<pre><code>[groups]
  &lt;ul&gt;
    &lt;li&gt;
...
[/groups]</code></pre>
		...
		<h2><?php _e( 'Example: A Simple Unordered Category list', W4PL_TD ); ?></h2>
		<pre><code>[terms]
  &lt;ul&gt;
...
[/terms]</code></pre>
		...
		<h2><?php _e( 'Example: Category Post list', W4PL_TD ); ?></h2>
		<pre><code>[terms]
  &lt;ul&gt;
    &lt;li&gt;
...
[/terms]</code></pre>
		...
		<h2><?php _e( 'Example: A Simple Unordered Users list', W4PL_TD ); ?></h2>
		<pre><code>[users]
  &lt;ul&gt;
...
[/users]</code></pre>
		...
		<h2><?php _e( 'Example: Users Post list', W4PL_TD ); ?></h2>
		<pre><code>[users]
  &lt;ul&gt;
    &lt;li&gt;
